<header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
        ...
        <!-- Masthead Subheading-->
        <p class="masthead-subheading font-weight-light mb-0">Mon blog sur les réseaux sociaux</p>
        <div>
            <a href="https://fr-fr.facebook.com/" class="text-dark"><i class="fa-brands fa-facebook"></i> facebook</a>
            <a href="https://twitter.com/?lang=fr" class="text-dark"><i class="fa-brands fa-twitter"></i> Twitter</a>
